...
//}
/**
 * Класс для представления задачи и связанных с ней комментариев для автора.
 *
 * Этот класс используется для передачи информации о задаче, включая ее идентификатор,
 * заголовок, описание, статус, приоритет, адрес электронной почты автора
...
public class TaskAndCommentsForAuthorFromDbDto {
    ...
    private static final Logger logger = LoggerFactory.getLogger(TaskAndCommentsForAuthorFromDbDto.class);
    ...
    /**
     * Конструктор для создания объекта TaskAndCommentsForAuthorFromDbDto.
     *
    ...
    public TaskAndCommentsForAuthorFromDbDto(Long id,
        ...
        logger.debug("Создан TaskAndCommentsForAuthorFromDbDto: {}", this);
    }
     ...
     */
    public TaskAndCommentsForAuthorFromDbDto() {
        logger.debug("Создан пустой TaskAndCommentsForAuthorFromDbDto");
    }
